...
## Development environment and release process
 ...
 - create virtualenv with Flask and bot_feedback installed into it (latter is installed in
...
install it (`pip install bot_feedback.tar.gz`), ensure that configuration file exists and
`BOT_FEEDBACK_SETTINGS` environment variable points to it, ensure that user has access to the
